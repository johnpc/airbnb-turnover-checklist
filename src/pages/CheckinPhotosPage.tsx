...
import { useCreateCheckinPhoto } from '@/hooks/use-photos'
...
export function CheckinPhotosPage() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl">
      <Card>
        <CardHeader>
          <CardTitle>Check-in Photos - {listing.name}</CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="text-center p-8">
            ...
            <p className="text-muted-foreground mb-6">Take a photo of the cleaned room</p>
          ...
          <Button variant="outline" onClick={() => navigate(`/stays/${stayId}`)} className="w-full">
            Skip for Now
          </Button>
        </CardContent>
      </Card>
